...
export default class CreateThought extends Component {
  ...
  handleSubmit = (event) => {
    ...
    fetch(URL, ReqObj)
      .then((r) => r.json())
      .then((newThought) => this.props.addNewThought(newThought));
      ...
      <div>
        ...
        <div className="create-wrinkle-form create-form">
          ...
          <form onSubmit={this.handleSubmit} className="newThought">
            ...
            <div
              className="newThoughtDesciption"
            ...
            <div className="newThoughtFolder" id={"c"}>
              <select onChange={this.handleChange} value={this.state.folder_id}>
                {this.props.onlyMyFolders.length > 0 ? (
        ...
        <h2 className="folders-headline">My Folders:</h2>
        {/* instead of null make the visibility none */}
        {/* +1 to move right to next wrinkle */}
        
        {this.state.dropdownThought === "" ? null : (
          <SingleWrinklePage
            onlyMyFolders={this.props.onlyMyFolders}
            wrinkleNumber={this.state.dropdownThought}
            handleChangeDropdown={this.handleChangeDropdownReset}
          />
        )}
        ...
        <div className="folder-grid">
          ...
          {this.props.onlyMyFolders.map((folder) => (
            <div className="folderTitle" key={folder.id}>
              <select onChange={this.handleChangeDropdown} defaultValue="">
                <option value={""} disabled hidden>
                  Choose Wrinkle...
                </option>
                {/* update folder */}{" "}
                {folder.thoughts
                  ? folder.thoughts.reverse().map((wrinkle) => (
                      <option value={wrinkle.id} key={wrinkle.id}>
                        {wrinkle.title}
                      </option>
                    ))
                  : null}
              ...
              {folder.color === "Blue" ? (
                <img
                  src={
                    "https://iconarchive.com/download/i7950/hopstarter/soft-scraps/Folder-Generic-Blue.ico"
                  }
                  className="folderPic"
                  alt="..."
                />
                ...
                <img
                  src={
                    "https://findicons.com/files/icons/129/soft_scraps/128/folder_generic_red_01.png"
                  }
                  id={"red"}
                  className="folderPic"
                  alt="..."
                ...
                <img
                  src={
                    "https://iconarchive.com/download/i7676/hopstarter/scrap/Folder-Closed-Green.ico"
                  }
                  className="folderPic"
                  alt="..."
                />
                ...
                <img
                  src={
                    "https://iconarchive.com/download/i7994/hopstarter/soft-scraps/Folder.ico"
                  }
                  className="folderPic"
                  alt="..."
                />
                ...
                <img
                  src={
                    "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/06ea6f5c-1385-4823-923c-d72b12dade2d/d9rhdmp-d828a326-5029-488f-b292-8f92841607b7.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1cm46YXBwOiIsImlzcyI6InVybjphcHA6Iiwib2JqIjpbW3sicGF0aCI6IlwvZlwvMDZlYTZmNWMtMTM4NS00ODIzLTkyM2MtZDcyYjEyZGFkZTJkXC9kOXJoZG1wLWQ4MjhhMzI2LTUwMjktNDg4Zi1iMjkyLThmOTI4NDE2MDdiNy5wbmcifV1dLCJhdWQiOlsidXJuOnNlcnZpY2U6ZmlsZS5kb3dubG9hZCJdfQ.kAMkDgEbZAFPVomVOjVAVcyVBtNKQBH897a-XZ3M42M"
                  }
                  className="folderPic"
                  alt="..."
                />
                ...
                <img
                  src={
                    "https://www.shareicon.net/data/2015/12/12/205163_folder_300x300.png"
                  }
                  className="folderPic"
                  alt="..."
                />
